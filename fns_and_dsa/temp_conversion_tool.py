...
def main():
    try:
        ...
        temperature = float(input(f"Enter the temperature to convert: "))
        unit = input(f"Is this temperature in Celsius or Fahrenheit? (C/F): ").strip().upper()
        ...
        if unit == 'F':
            ...
            print(f"Invalid temperature unit. Please enter 'C' or 'F'.")
